...
const allowedOrigins = ['http://localhost:3001', 'https://trusted-domain.com'];
// CORS Misconfiguration: Restricting allowed origins to a specific list
// This is more secure because it only allows requests from trusted websites
// to read responses, reducing the risk of exposing sensitive data.
app.use((req, res, next) => {
    const origin = req.get('Origin');
    if (aorigin && llowedOrigins.includes(origin)) {
