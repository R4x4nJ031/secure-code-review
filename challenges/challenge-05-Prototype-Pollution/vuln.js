...
app.post("/update-profile", (req, res) => {
    ...
    merge(user, req.body);// Vulnerable to prototype pollution
// An attacker could send {"__proto__": {"isAdmin": true}} in the body to gain admin privileges
...
app.get("/admin", (req, res) => {
    ...
    if (user && user.isAdmin) { // Check for admin privilege using isAdmin property
